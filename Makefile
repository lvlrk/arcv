#############################################################################
# Makefile for building: bin/arcv
# Generated by qmake (3.1) (Qt 5.15.8)
# Project:  arcv.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile arcv.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = arcv1.0.0
DISTDIR = /media/sdb1/Code/arcv/build/arcv1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		arcv.pro include/types.h src/arcv.c
QMAKE_TARGET  = arcv
DESTDIR       = bin/
TARGET        = bin/arcv
...
Makefile: arcv.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/types.h $(DISTDIR)/
	$(COPY_FILE) --parents src/arcv.c $(DISTDIR)/
...
build/arcv.o: src/arcv.c 
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/arcv.o src/arcv.c
